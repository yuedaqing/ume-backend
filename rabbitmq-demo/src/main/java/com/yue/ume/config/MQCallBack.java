...
@Component
@Slf4j
public abstract class MQCallBack implements ConfirmCallback, ReturnsCallback{
    ...
    public void returnedMessage(ReturnedMessage returnedMessage) {
        log.info("消息：{}，被交换机:{}退回，退回原因：{}，路由Key：{}",
                StrUtil.utf8Str(returnedMessage.getMessage().getBody()), returnedMessage.getExchange(),
